  ...
  */
  ...
  public static class PrimitiveListNode extends ListNode {
    ...
    protected void buildJavaAccessor( ObjectAccessor objAccessor, FieldValueFactory factory ) {
      ...
      define( arrayAccessor, arrayAccessor.elementAccessor( ) );
    }
  }
  ...
  public static class ObjectListNode extends ListNode {
    ...
    protected void buildJavaAccessor( ObjectAccessor objAccessor, FieldValueFactory factory ) {
      ...
      ObjectAccessor memberObjAccessor = (ObjectAccessor) objArrayAccessor.elementAccessor();
  ...
  public static class StructureListNode extends ListNode {
    ...
    protected void buildJavaAccessor(ObjectAccessor objAccessor, FieldValueFactory factory) {
      ...
      ObjectArrayAccessor objArrayAccessor = new ObjectArrayAccessor( objAccessor );
      ObjectAccessor memberAccessor = (ObjectAccessor) objArrayAccessor.elementAccessor();
  ...
  public TupleValueImpl build( TupleSchema schema ) {
    int n = schema.count();
    ...
    TupleValueImpl tuple = new TupleValueImpl( schema, containerSet );
    if ( ! resets.isEmpty() ) {
