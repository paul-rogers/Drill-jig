...
import org.apache.drill.jig.api.json.JsonScanner.JsonTupleReader;
...
public class JsonSchemaBuilderMulti
{
  ...
  {
    if ( oldField.getType() == DataType.MAP || newField.getType() == DataType.MAP ) {
      if ( oldField.getType() != DataType.MAP  ||  newField.getType() != DataType.MAP ) {
        return false;
      }
